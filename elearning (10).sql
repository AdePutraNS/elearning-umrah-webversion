...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2017 at 08:51 AM
...
CREATE TABLE `tb_ikut_kuis` (
  ...
  `jwb` varchar(1024) NOT NULL,
  `waktu_selesai` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tb_ikut_kuis`
--

INSERT INTO `tb_ikut_kuis` (`kd_kuis`, `username`, `no_soal`, `jwb`, `waktu_selesai`) VALUES
(0, '150155201015', 1, 'A', '2017-06-07 04:18:29'),
(0, '150155201015', 2, 'B', '2017-06-07 04:18:29');
...
('Analisa dan Perancangan Perangkat Lunak', 'TI0003', 'DSN0002', '07:20:00', 2, 4, 2, 'A'),
('Analisa Berorientasi Objek', 'TI0002', 'DSN0002', '07:30:00', 2, 4, 4, 'A'),
('Probabilistik dan Statistika', 'TI0005', 'DSN0002', '14:10:00', 3, 4, 1, 'B'),
('Program Berorientasi Objek', 'TI0006', 'DSN0003', '13:20:00', 4, 2, 2, 'A'),
('Sistem Digital', 'TI0007', 'DSN0003', '07:30:00', 3, 4, 4, 'A'),
('Jaringan Komputer', 'TI0008', 'DSN0003', '07:30:00', 3, 2, 3, 'A'),
('Alpro', 'TI0009', 'DSN0004', '07:30:00', 4, 2, 1, 'B'),
('TBFO', 'TI0010', 'DSN0004', '13:20:00', 2, 4, 5, 'A'),
('PPMPL', 'TI0011', 'DSN0004', '07:30:00', 2, 4, 5, 'A'),
('MatVek', 'TI0012', 'DSN0005', '10:30:00', 3, 4, 5, 'A'),
('MatDis', 'TI0013', 'DSN0005', '15:00:00', 3, 6, 4, 'B'),
('MetNum', 'TI0014', 'DSN0005', '10:00:00', 3, 6, 4, 'A'),
('Alpro', 'TI0015', 'DSN0001', '07:30:00', 4, 2, 4, 'B'),
('Fisika Dasar', 'TI0004', 'DSN0001', '07:30:00', 3, 4, 4, 'B');
...
('DSN0002', 'b1219ez', 'nurul.hayaty27@gmail.com', 'Nurul Hayati', 2, 'Informatic Enginering', 'Bt. 7', 'Di Rumah', '1990-06-20', 'islam', 'B'),
('DSN0003', 'b1219ez', 'radziratomi@gmail.com', 'Ahmad Radzi Ratomi', 2, 'Informatic Enginering', 'Bt. 11', 'Di Rumah', '1988-06-20', 'islam', 'C'),
('DSN0004', 'b1219ez', 'nerfita@gmail.com', 'Nerfita Nikentari', 2, 'Informatic Enginering', 'Bt. 16', 'Di Rumah', '1986-06-20', 'islam', 'D'),
('DSN0005', 'b1219ez', 'betiza@gmail.com', 'Martaleli Betiza', 2, 'Informatic Enginering', 'Bt. 8', 'Di Rumah', '1980-06-20', 'islam', 'E');
